...
class RoverState():
    def __init__(self):
        ...
        self.rock_nav_angle = None  # angles for the rock samples pixels
        self.rock_nav_dist = None # distance to rock sample pixels
        ...
        self.debug = 'start' # current state of the rover for debugging.
